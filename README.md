# nvim-treesitter-queries-gitattributes

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gitattributes/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gitattributes/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gitattributes**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gitattributes",
...
- [ ] Changes are scoped to `gitattributes` — do not include files for other languages
